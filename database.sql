...
UPDATE "accounts" SET "account_balance" = 10.00 WHERE "transactions_attempted" = '0' AND "account_balance" = 0.00;--Select all users that have attempted 9 or more transactions.
...
VALUES ('Jake', 'Huntington Beach', '0', '0', '0.00');
